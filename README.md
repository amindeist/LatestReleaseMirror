...
| File | Size | Download |
|------|------|----------|
| `setup-Happ.arm64.exe` | 80.2 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/Happ-proxy/happ-desktop/setup-Happ.arm64.exe) |
...
| `setup-Happ.x64.exe (part 2 of 2)` | 23.3 MB | [⬇️ Download (Part 2)](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/Happ-proxy/happ-desktop/setup-Happ.x64.exe.002) |
...
🔗 [source](https://github.com/telegramdesktop/tdesktop) – [<code><small>v7.1.3</small></code>](https://github.com/telegramdesktop/tdesktop/releases/tag/v7.1.3)

| File | Size | Download |
|------|------|----------|
| `tsetup-x64.7.1.3.exe` | 52.6 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/telegramdesktop/tdesktop/tsetup-x64.7.1.3.exe) |
