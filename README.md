...
🔗 [source](https://github.com/telegramdesktop/tdesktop) – [<code><small>v7.0.2</small></code>](https://github.com/telegramdesktop/tdesktop/releases/tag/v7.0.2)

| File | Size | Download |
|------|------|----------|
| `tsetup-x64.7.0.2.exe` | 51.6 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/telegramdesktop/tdesktop/tsetup-x64.7.0.2.exe) |
