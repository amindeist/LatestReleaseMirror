...
🔗 [source](https://github.com/Happ-proxy/happ-desktop) – [<code><small>4.2.1</small></code>](https://github.com/Happ-proxy/happ-desktop/releases/tag/4.2.1)

| File | Size | Download |
|------|------|----------|
| `setup-Happ.arm64.exe` | 80.3 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/Happ-proxy/happ-desktop/setup-Happ.arm64.exe) |
...
| `setup-Happ.x64.exe (part 2 of 2)` | 23.4 MB | [⬇️ Download (Part 2)](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/Happ-proxy/happ-desktop/setup-Happ.x64.exe.002) |
...
🔗 [source](https://github.com/center2055/OnionHop) – [<code><small>v3.8.2</small></code>](https://github.com/center2055/OnionHop/releases/tag/v3.8.2)

| File | Size | Download |
|------|------|----------|
| `OnionHop-CLI-Setup-3.8.2.exe` | 86.3 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/center2055/OnionHop/OnionHop-CLI-Setup-3.8.2.exe) |
...
🔗 [source](https://github.com/davudsedft/purvpn) – [<code><small>15.8</small></code>](https://github.com/davudsedft/purvpn/releases/tag/15.8)

| File | Size | Download |
|------|------|----------|
| `PurVpn-15.8-arm64-v8a.apk` | 55.7 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-arm64-v8a.apk) |
| `PurVpn-15.8-armeabi-v7a.apk` | 49.2 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-armeabi-v7a.apk) |
| `PurVpn-15.8-universal.apk (part 1 of 2)` | 90.0 MB | [⬇️ Download (Part 1)](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-universal.apk.001) |
| `PurVpn-15.8-universal.apk (part 2 of 2)` | 38.0 MB | [⬇️ Download (Part 2)](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-universal.apk.002) |
| `PurVpn-15.8-x86.apk` | 51.3 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-x86.apk) |
| `PurVpn-15.8-x86_64.apk` | 50.6 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/davudsedft/purvpn/PurVpn-15.8-x86_64.apk) |
...
🔗 [source](https://github.com/mirarr-app/network-checker) – [<code><small>1.7.0</small></code>](https://github.com/mirarr-app/network-checker/releases/tag/1.7.0)

| File | Size | Download |
|------|------|----------|
| `app-arm64-v8a-release.apk` | 31.7 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/mirarr-app/network-checker/app-arm64-v8a-release.apk) |
...
| `app-release.apk` | 54.5 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/mirarr-app/network-checker/app-release.apk) |
| `rdnbenet-linux-x64.zip` | 19.8 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/mirarr-app/network-checker/rdnbenet-linux-x64.zip) |
| `rdnbenet-windows.zip` | 22.0 MB | [⬇️ Download](https://raw.githubusercontent.com/amindeist/LatestReleaseMirror/main/releases/mirarr-app/network-checker/rdnbenet-windows.zip) |
